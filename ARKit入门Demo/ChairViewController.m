...
@interface ChairViewController () <ARSessionDelegate, ARSCNViewDelegate>
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    CGFloat scale = 0.5f;
    shipNode.scale = SCNVector3Make(scale, scale, scale);
    [shipNode runAction:[SCNAction repeatActionForever:[SCNAction rotateByX:0 y:200000000 z:0 duration:1]]]; // 自身y轴旋转
    //3.将飞机节点添加到当前屏幕中
